...
//	Method getTimeout;
	...
	public BasicTagTechnologyWrapper(Tag tag, String tech)
...
//		setTimeout = cls.getMethod("setTimeout");
//		getTimeout = cls.getMethod("getTimeout");
	...
	/*
	 * public int getMaxTransceiveLength() { try { return
	 * (Integer)getMaxTransceiveLength.invoke(mTagTech); } catch
	 * (IllegalArgumentException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } catch (IllegalAccessException e) { // TODO
	 * Auto-generated catch block e.printStackTrace(); } catch
	 * (InvocationTargetException e) { if (e.getTargetException() instanceof
	 * RuntimeException) { throw (RuntimeException) e.getTargetException(); }
	...
	/*
	 * @Override public void reconnect() throws IOException { // TODO
