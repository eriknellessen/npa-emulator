...
public class CVCertBody extends ASN1Encodable{
	 ...
	 * by Ole
	 */
	public DERSequence getExtensions() {
		if(extensions != null)
			return extensions;
		return null;
	}
	 ...
	 * @throws IOException 
	 */
	public byte[] getCertificateDescription() throws IOException {
		if(extensions != null) {
			return ((DERApplicationSpecific) extensions.getObjectAt(0)).getObject(DERTags.OCTET_STRING).getDEREncoded();
		}
		return new byte[] {};
	}
